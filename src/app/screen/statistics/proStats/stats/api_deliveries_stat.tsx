...
/** Images */
const icon = "/img/stats/shop_api_icon.svg";

//TOdo = typeHinting;
function ApiDeliveriesStat(props: { provider: RecoilValueReadOnly<any> }) {
  ...
  return (
    <StatsCard icon={icon} alt="Cart price average logo">
      ...
      <Text textStyle={theme.textTheme.title.large}>
        {stats.deliveriesFromApi}
      </Text>
    </StatsCard>
  );
}

export default ApiDeliveriesStat;
