...
export default class PasswordChecker {
    ...
    private setBasicCase($case: JQuery<HTMLElement>) {
        ...
        $case.find("i:not(.cf-information-circle)").html("fiber_manual_record");
    }
    ...
    private setValidCase($case: JQuery<HTMLElement>) {
        $case
            ...
            .addClass("valid");
        $case.find("i:not(.cf-information-circle)").html("check");
    }
     ...
     * @private
     */
    private setInvalidCase($case: JQuery) {
        $case
            .removeClass("valid")
            .removeClass("basic-check")
            .addClass("invalid");
        $case.find("i:not(.cf-information-circle)").html("close");
    }
}