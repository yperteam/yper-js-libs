...
export interface MissionPrice {
  ...
  totalTtc: number;
  tva: number;
  detail: { discounts: []; surcharges: PriceSurcharge[] };
}

export interface Mission {
  id: string;
  comment?: string;
  date: { deliveryEnd?: Date; deliveryStart?: Date }; //, "edition_limit": null, "pickup_end": null, "pickup_start": null },
  ...
  missionTemplate?: { id: string; name: string };
  options: string[];
  order: { id: string; idFull: string };
  orderId: string;
  price: MissionPrice;
